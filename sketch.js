...
function setup() {
	...
	bob1 = new bob(320,490,40);
	bob2 = new bob(360,490,40);
	bob3 = new bob(380,490,40);
	bob4 = new bob(400,490,40);
	bob5 = new bob(420,490,40);
...
function keyPressed(){
	...
	if(keyCode === UP_ARROW ){
		Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-58,y:-45})
